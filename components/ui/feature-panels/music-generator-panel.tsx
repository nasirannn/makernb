...
const leadInstruments: Array<{ id: string; name: string }> = [];
const drumKits: Array<{ id: string; name: string }> = [];
...
export const MusicGeneratorPanel = (props: FeatureCreatePanelProps) => {
  const {
    panelOpen,
  ...
  const effectiveModel: MusicModel = selectedModel;
    ...
    >
      ...
      {mode === "simple" ? (
        ...
        <StudioCustomModeContent
          ...
          showAdvancedOptions={activeUploadIntent === "track"}
          isPublished={isPublished}
          onPublicVisibilityChange={handlePublicVisibilityChange}
          canDisablePublicVisibility={canControlPublicVisibility}
        />
