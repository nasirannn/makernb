...
export const StudioCustomModeContent: React.FC<StudioCustomModeContentProps> = ({
  ...
  const singleUploadIntent = showTrackIntent && !showVocalIntent && !showMelodyIntent
    ? "track"
    : showVocalIntent && !showTrackIntent && !showMelodyIntent
      ? "vocal"
      : showMelodyIntent && !showTrackIntent && !showVocalIntent
        ? "melody"
        : null;
  const showPrimaryUploadCard = canShowUploadActionsBase && (
    (preferTrackUploadCard && singleUploadIntent === "track") || singleUploadIntent === "melody"
  );
  const canShowAddAudioActions = canShowUploadActionsBase && !showPrimaryUploadCard;
        ...
        <section className="space-y-3">
          {showPrimaryUploadCard && (
            <UploadEmptyStateCard
              ...
              clickTitle={t("featurePanel.addAudio")}
